...
/*   Updated: 2024/05/05 18:47:39 by krwongwa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void julia(t_fractal *fractal)
{
	...
	y = - fractal->centery; // Start from the top-left corner
	while (y < fractal->centery)
	{
		...
		while (x < fractal->centerx)
		{
			...
			mlx_put_pixel(fractal->image, fractal->centerx + x, fractal->centery + y, color);
			x++;
		}
	y++;
	}
